    ...
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          ...
          <div>
            <h1 className="brand-title">Sandy Devops & Cloud & Developer(Azure & AWS)</h1>
            <p className="nav-subtitle">User Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to Sandy Devops 🚀 & Cloud(Azure & Aws)" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} Sandy Devops. All rights reserved.</p>
      </footer>
